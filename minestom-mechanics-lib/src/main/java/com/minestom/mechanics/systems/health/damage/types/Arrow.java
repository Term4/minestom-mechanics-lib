...
/** Arrow damage type. Event-only, no tick tracking. */
public final class Arrow extends DamageTracker {
    @Override public String id() { return "arrow"; }
    @Override public DamageTypeProperties defaultProperties() { return DamageTypeProperties.ATTACK_DEFAULT; }
    @Override public RegistryKey<?>[] matchedTypes() { return new RegistryKey<?>[]{ DamageType.ARROW }; }

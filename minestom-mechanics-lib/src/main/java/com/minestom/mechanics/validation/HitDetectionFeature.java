 ...
 */
public class HitDetectionFeature extends InitializableSystem {
    private static HitDetectionFeature instance;
    ...
    private HitDetectionFeature(HitDetectionConfig hitDetectionConfig) {
     ...
     */
    public static HitDetectionFeature initialize(HitDetectionConfig hitDetectionConfig) {
        if (instance != null && instance.isInitialized()) {
            LogUtil.logAlreadyInitialized("HitDetectionFeature");
            return instance;
        }

        instance = new HitDetectionFeature(hitDetectionConfig);
    ...
    public static HitDetectionFeature getInstance() {
        if (instance == null) {
